...
print(graph.getDijkstraPath(0, 1))
print(graph.getDijkstraPath(0, 2))
print(graph.getDijkstraPath(0, 3))
print(graph.getDijkstraPath(0, 4))
print(graph.getDijkstraPath(0, 5))
print(graph.getDijkstraPath(0, 6))
"""
